...
static void init_i2c(aipi_lite_ctx_t *ctx)
{
...
static void init_lcd_display(aipi_lite_ctx_t *ctx)
{
...
static void init_buttons(aipi_lite_ctx_t *ctx)
{
...
static const char *aipi_get_board_type(board_desc_t *self)
{
    (void)self;
    return BOARD_TYPE;
}

static void *aipi_get_led(board_desc_t *self)
{
...
static void *aipi_get_audio_codec(board_desc_t *self)
{
    aipi_lite_ctx_t *ctx = (aipi_lite_ctx_t *)self;
    if (!ctx->codec) {
...
static void *aipi_get_display(board_desc_t *self)
{
    aipi_lite_ctx_t *ctx = (aipi_lite_ctx_t *)self;
    return ctx->display;
}

static void *aipi_get_backlight(board_desc_t *self)
{
    aipi_lite_ctx_t *ctx = (aipi_lite_ctx_t *)self;
...
{
    aipi_lite_ctx_t *ctx = calloc(1, sizeof(aipi_lite_ctx_t));
    if (!ctx) return NULL;

    ctx->base.kind = BOARD_KIND_WIFI;
    ctx->base.get_board_type = aipi_get_board_type;
    ctx->base.get_led = aipi_get_led;
    ctx->base.get_audio_codec = aipi_get_audio_codec;
    ctx->base.get_display = aipi_get_display;
    ctx->base.get_backlight = aipi_get_backlight;
    ctx->base.destroy = aipi_destroy;
