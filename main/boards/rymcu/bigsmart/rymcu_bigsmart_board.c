...
static void init_i2c(bigsmart_ctx_t *ctx)
{
...
static void init_spi(bigsmart_ctx_t *ctx)
{
    (void)ctx;
...
static void init_st7789_display(bigsmart_ctx_t *ctx)
{
...
static void init_buttons(bigsmart_ctx_t *ctx)
{
...
{
    bigsmart_ctx_t *ctx = (bigsmart_ctx_t *)self;
    if (!ctx->codec) {
...
static void *get_display(board_desc_t *self) { return ((bigsmart_ctx_t *)self)->display; }
...
{
    bigsmart_ctx_t *ctx = calloc(1, sizeof(bigsmart_ctx_t));
    if (!ctx) return NULL;
