...
static void init_i2c(ledong_ctx_t *ctx)
{
...
static void init_jd9853_display(ledong_ctx_t *ctx)
{
    ...
    i2c_master_bus_add_device(ctx->i2c_bus, &dev_cfg, &dev_handle);
...
static void init_buttons(ledong_ctx_t *ctx)
{
...
{
    ledong_ctx_t *ctx = (ledong_ctx_t *)self;
...
static void *get_display(board_desc_t *self) { return ((ledong_ctx_t *)self)->display; }
...
{
    ledong_ctx_t *ctx = calloc(1, sizeof(ledong_ctx_t));
    if (!ctx) return NULL;
