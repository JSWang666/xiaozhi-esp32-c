...
} atk_dnesp32s3_box2_wifi_ctx_t;

static atk_dnesp32s3_box2_wifi_ctx_t *s_instance;

static uint8_t io_expander_get_level(atk_dnesp32s3_box2_wifi_ctx_t *ctx, uint16_t pin_mask)
{
    uint32_t pin_val = 0;
...
{
    atk_dnesp32s3_box2_wifi_ctx_t *ctx = (atk_dnesp32s3_box2_wifi_ctx_t *)usr_data;
    if (!ctx->codec) return;
...
static void init_i2c(atk_dnesp32s3_box2_wifi_ctx_t *ctx)
{
...
static void init_io_expander(atk_dnesp32s3_box2_wifi_ctx_t *ctx)
{
...
static void init_display(atk_dnesp32s3_box2_wifi_ctx_t *ctx)
{
...
static void init_buttons(atk_dnesp32s3_box2_wifi_ctx_t *ctx)
{
    s_instance = ctx;
...
{
    atk_dnesp32s3_box2_wifi_ctx_t *ctx = calloc(1, sizeof(atk_dnesp32s3_box2_wifi_ctx_t));
    if (!ctx) return NULL;
