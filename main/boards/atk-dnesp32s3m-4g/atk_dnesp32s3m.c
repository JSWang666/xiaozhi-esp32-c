...
{
    atk_dnesp32s3m_4g_ctx_t *ctx = (atk_dnesp32s3m_4g_ctx_t *)ud;
    if (!ctx->codec) return;
...
static void init_i2c(atk_dnesp32s3m_4g_ctx_t *ctx)
{
...
static void init_display(atk_dnesp32s3m_4g_ctx_t *ctx)
{
...
static void init_buttons(atk_dnesp32s3m_4g_ctx_t *ctx)
{
...
{
    atk_dnesp32s3m_4g_ctx_t *ctx = (atk_dnesp32s3m_4g_ctx_t *)self;
    if (!ctx->led) {
...
{
    atk_dnesp32s3m_4g_ctx_t *ctx = calloc(1, sizeof(atk_dnesp32s3m_4g_ctx_t));
    if (!ctx) return NULL;
