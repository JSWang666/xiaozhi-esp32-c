...
static void init_i2c(esp_box_ctx_t *ctx)
{
...
static void init_display(esp_box_ctx_t *ctx)
{
...
static void init_buttons(esp_box_ctx_t *ctx)
{
...
{
    esp_box_ctx_t *ctx = (esp_box_ctx_t *)self;
    if (!ctx->codec) {
...
{
    esp_box_ctx_t *ctx = calloc(1, sizeof(esp_box_ctx_t));
    if (!ctx) return NULL;
