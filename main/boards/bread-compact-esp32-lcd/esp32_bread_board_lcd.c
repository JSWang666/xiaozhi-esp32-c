...
static void init_lcd_display(esp32_bread_lcd_ctx_t *ctx)
{
...
static void init_buttons(esp32_bread_lcd_ctx_t *ctx)
{
...
static const char *ebl_get_board_type(board_desc_t *self)
{
    (void)self;
    return BOARD_TYPE;
}

static void *ebl_get_led(board_desc_t *self)
{
...
static void *ebl_get_audio_codec(board_desc_t *self)
{
    esp32_bread_lcd_ctx_t *ctx = (esp32_bread_lcd_ctx_t *)self;
    if (!ctx->codec) {
...
static void *ebl_get_display(board_desc_t *self)
{
    esp32_bread_lcd_ctx_t *ctx = (esp32_bread_lcd_ctx_t *)self;
    return ctx->display;
}

static void *ebl_get_backlight(board_desc_t *self)
{
    esp32_bread_lcd_ctx_t *ctx = (esp32_bread_lcd_ctx_t *)self;
...
{
    esp32_bread_lcd_ctx_t *ctx = calloc(1, sizeof(esp32_bread_lcd_ctx_t));
    if (!ctx) return NULL;

    ctx->base.kind = BOARD_KIND_WIFI;
    ctx->base.get_board_type = ebl_get_board_type;
    ctx->base.get_led = ebl_get_led;
    ctx->base.get_audio_codec = ebl_get_audio_codec;
    ctx->base.get_display = ebl_get_display;
    ctx->base.get_backlight = ebl_get_backlight;
    ctx->base.destroy = ebl_destroy;
