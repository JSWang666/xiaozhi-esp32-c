...
static void init_codec_i2c(moji2_ctx_t *ctx)
{
...
static void init_spi(moji2_ctx_t *ctx)
{
    (void)ctx;
...
static void init_st77916_display(moji2_ctx_t *ctx)
{
...
static void init_buttons(moji2_ctx_t *ctx)
{
...
{
    moji2_ctx_t *ctx = (moji2_ctx_t *)self;
...
static void *get_display(board_desc_t *self) { return ((moji2_ctx_t *)self)->display; }
...
{
    moji2_ctx_t *ctx = calloc(1, sizeof(moji2_ctx_t));
    if (!ctx) return NULL;
