...
} atoms3r_echo_base_ctx_t;

static void init_buttons(atoms3r_echo_base_ctx_t *ctx);
...
static void init_i2c(atoms3r_echo_base_ctx_t *ctx)
{
...
static void i2c_detect(atoms3r_echo_base_ctx_t *ctx)
{
...
static void init_pi4ioe(atoms3r_echo_base_ctx_t *ctx)
{
...
static void init_lp5562(atoms3r_echo_base_ctx_t *ctx)
{
...
static void init_spi(atoms3r_echo_base_ctx_t *ctx)
{
    (void)ctx;
...
static void init_gc9107_display(atoms3r_echo_base_ctx_t *ctx)
{
...
static void check_echo_base_connection(atoms3r_echo_base_ctx_t *ctx)
{
...
{
    atoms3r_echo_base_ctx_t *ctx = calloc(1, sizeof(atoms3r_echo_base_ctx_t));
    if (!ctx) return NULL;
