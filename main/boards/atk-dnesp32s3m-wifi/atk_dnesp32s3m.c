...
{
    atk_dnesp32s3m_wifi_ctx_t *ctx = (atk_dnesp32s3m_wifi_ctx_t *)ud;
    if (!ctx->codec) return;
...
static void init_i2c(atk_dnesp32s3m_wifi_ctx_t *ctx)
{
...
static void init_display(atk_dnesp32s3m_wifi_ctx_t *ctx)
{
    ...
    esp_lcd_panel_io_tx_param(ctx->panel_io, 0xe0, data0, 16);
    esp_lcd_panel_io_tx_param(ctx->panel_io, 0xe1, data1, 16);
...
static void init_buttons(atk_dnesp32s3m_wifi_ctx_t *ctx)
{
...
{
    atk_dnesp32s3m_wifi_ctx_t *ctx = (atk_dnesp32s3m_wifi_ctx_t *)self;
    if (!ctx->led) {
...
{
    atk_dnesp32s3m_wifi_ctx_t *ctx = calloc(1, sizeof(atk_dnesp32s3m_wifi_ctx_t));
    if (!ctx) return NULL;
