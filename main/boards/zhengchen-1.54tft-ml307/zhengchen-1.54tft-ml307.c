...
{
    zhengchen_ml307_ctx_t *ctx = (zhengchen_ml307_ctx_t *)ud;
    if (!ctx->codec) return;
...
static void init_st7789_display(zhengchen_ml307_ctx_t *ctx)
{
...
static void init_buttons(zhengchen_ml307_ctx_t *ctx)
{
...
{
    zhengchen_ml307_ctx_t *ctx = (zhengchen_ml307_ctx_t *)self;
    if (!ctx->codec) {
...
{
    zhengchen_ml307_ctx_t *ctx = calloc(1, sizeof(zhengchen_ml307_ctx_t));
    if (!ctx) return NULL;
