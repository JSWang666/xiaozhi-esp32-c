...
static void init_codec_i2c(xmini_c3_ctx_t *ctx)
{
...
static void init_ssd1306_display(xmini_c3_ctx_t *ctx)
{
...
static void init_buttons(xmini_c3_ctx_t *ctx)
{
...
{
    xmini_c3_ctx_t *ctx = (xmini_c3_ctx_t *)self;
    if (!ctx->led) {
...
{
    xmini_c3_ctx_t *ctx = calloc(1, sizeof(xmini_c3_ctx_t));
    if (!ctx) return NULL;
