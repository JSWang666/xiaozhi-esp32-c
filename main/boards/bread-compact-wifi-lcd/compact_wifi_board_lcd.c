...
static void init_lcd_display(compact_wifi_lcd_ctx_t *ctx)
{
...
static void init_buttons(compact_wifi_lcd_ctx_t *ctx)
{
...
{
    compact_wifi_lcd_ctx_t *ctx = (compact_wifi_lcd_ctx_t *)ud;
...
static void init_tools(compact_wifi_lcd_ctx_t *ctx)
{
...
static const char *cwl_get_board_type(board_desc_t *self)
{
    (void)self;
    return BOARD_TYPE;
}

static void *cwl_get_led(board_desc_t *self)
{
...
static void *cwl_get_audio_codec(board_desc_t *self)
{
    compact_wifi_lcd_ctx_t *ctx = (compact_wifi_lcd_ctx_t *)self;
    if (!ctx->codec) {
...
static void *cwl_get_display(board_desc_t *self)
{
    compact_wifi_lcd_ctx_t *ctx = (compact_wifi_lcd_ctx_t *)self;
    return ctx->display;
}

static void *cwl_get_backlight(board_desc_t *self)
{
    compact_wifi_lcd_ctx_t *ctx = (compact_wifi_lcd_ctx_t *)self;
...
{
    compact_wifi_lcd_ctx_t *ctx = calloc(1, sizeof(compact_wifi_lcd_ctx_t));
    if (!ctx) return NULL;

    ctx->base.kind = BOARD_KIND_WIFI;
    ctx->base.get_board_type = cwl_get_board_type;
    ctx->base.get_led = cwl_get_led;
    ctx->base.get_audio_codec = cwl_get_audio_codec;
    ctx->base.get_display = cwl_get_display;
    ctx->base.get_backlight = cwl_get_backlight;
    ctx->base.destroy = cwl_destroy;
    ...
    if (DISPLAY_BACKLIGHT_PIN != GPIO_NUM_NC) {
        backlight_t *bl = cwl_get_backlight(&ctx->base);
