...
{
    aivox3_ctx_t *ctx = (aivox3_ctx_t *)ud;
    if (!ctx->codec) return;
...
static void init_i2c(aivox3_ctx_t *ctx)
{
...
static void init_spi(aivox3_ctx_t *ctx)
{
    (void)ctx;
...
static void init_lcd_display(aivox3_ctx_t *ctx)
{
...
static void init_buttons(aivox3_ctx_t *ctx)
{
...
{
    aivox3_ctx_t *ctx = (aivox3_ctx_t *)self;
...
static void *get_display(board_desc_t *self) { return ((aivox3_ctx_t *)self)->display; }
...
{
    aivox3_ctx_t *ctx = calloc(1, sizeof(aivox3_ctx_t));
    if (!ctx) return NULL;
