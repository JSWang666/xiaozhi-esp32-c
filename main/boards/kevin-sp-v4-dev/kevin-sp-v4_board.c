...
static void init_codec_i2c(kevin_sp_v4_ctx_t *ctx)
{
...
static const char *get_board_type(board_desc_t *self) { (void)self; return "kevin-sp-v4-dev"; }
static void *get_led(board_desc_t *self) { return ((kevin_sp_v4_ctx_t *)self)->led; }
static void *get_audio_codec(board_desc_t *self) { return ((kevin_sp_v4_ctx_t *)self)->codec; }
static void *get_display(board_desc_t *self) { return ((kevin_sp_v4_ctx_t *)self)->display; }
static void *get_backlight(board_desc_t *self) { return ((kevin_sp_v4_ctx_t *)self)->backlight; }
...
{
    kevin_sp_v4_ctx_t *ctx = calloc(1, sizeof(*ctx));
    if (!ctx) return NULL;
