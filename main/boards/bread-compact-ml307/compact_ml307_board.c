...
{
    compact_ml307_ctx_t *ctx = (compact_ml307_ctx_t *)ud;
    if (!ctx->codec) return;
...
static void init_display_i2c(compact_ml307_ctx_t *ctx)
{
...
static void init_ssd1306_display(compact_ml307_ctx_t *ctx)
{
...
static void init_buttons(compact_ml307_ctx_t *ctx)
{
...
static void init_tools(compact_ml307_ctx_t *ctx)
{
...
static const char *cmb_get_board_type(board_desc_t *self)
{
    (void)self;
    return BOARD_TYPE;
}

static void *cmb_get_led(board_desc_t *self)
{
    compact_ml307_ctx_t *ctx = (compact_ml307_ctx_t *)self;
    if (!ctx->led) {
...
static void *cmb_get_audio_codec(board_desc_t *self)
{
    compact_ml307_ctx_t *ctx = (compact_ml307_ctx_t *)self;
    if (!ctx->codec) {
...
static void *cmb_get_display(board_desc_t *self)
{
    compact_ml307_ctx_t *ctx = (compact_ml307_ctx_t *)self;
    return ctx->display;
}

static void cmb_destroy(board_desc_t *self)
{
    compact_ml307_ctx_t *ctx = (compact_ml307_ctx_t *)self;
...
{
    compact_ml307_ctx_t *ctx = calloc(1, sizeof(compact_ml307_ctx_t));
    if (!ctx) return NULL;

    ctx->base.kind = BOARD_KIND_ML307;
    ctx->base.get_board_type = cmb_get_board_type;
    ctx->base.get_led = cmb_get_led;
