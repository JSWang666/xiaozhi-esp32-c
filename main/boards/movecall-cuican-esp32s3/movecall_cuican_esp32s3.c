...
static void init_codec_i2c(cuican_ctx_t *ctx)
{
...
static void init_spi(cuican_ctx_t *ctx)
{
    (void)ctx;
...
static void init_gc9a01_display(cuican_ctx_t *ctx)
{
...
static void init_buttons(cuican_ctx_t *ctx)
{
...
{
    cuican_ctx_t *ctx = (cuican_ctx_t *)self;
    if (!ctx->led) {
...
{
    cuican_ctx_t *ctx = calloc(1, sizeof(cuican_ctx_t));
    if (!ctx) return NULL;
