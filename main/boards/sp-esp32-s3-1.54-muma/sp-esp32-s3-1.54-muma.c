...
static void init_codec_i2c(sp154_ctx_t *ctx)
{
...
static void init_spi(sp154_ctx_t *ctx)
{
    (void)ctx;
...
static void init_st7789_display(sp154_ctx_t *ctx)
{
...
static void init_buttons(sp154_ctx_t *ctx)
{
...
{
    sp154_ctx_t *ctx = (sp154_ctx_t *)self;
...
static void *get_display(board_desc_t *self) { return ((sp154_ctx_t *)self)->display; }
...
{
    sp154_ctx_t *ctx = calloc(1, sizeof(sp154_ctx_t));
    if (!ctx) return NULL;
