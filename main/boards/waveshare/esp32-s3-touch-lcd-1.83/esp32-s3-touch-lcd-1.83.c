...
static void init_i2c(ws183_ctx_t *ctx)
{
...
static void init_display(ws183_ctx_t *ctx)
{
...
static void init_buttons(ws183_ctx_t *ctx)
{
...
{
    ws183_ctx_t *ctx = calloc(1, sizeof(ws183_ctx_t));
    if (!ctx) return NULL;
