...
{
    ws154_ctx_t *ctx = (ws154_ctx_t *)ud;
    if (!ctx->codec) return;
...
static void init_i2c(ws154_ctx_t *ctx)
{
...
static void init_lcd_display(ws154_ctx_t *ctx)
{
...
static void init_buttons(ws154_ctx_t *ctx)
{
...
{
    ws154_ctx_t *ctx = (ws154_ctx_t *)self;
    if (!ctx->codec) {
...
{
    ws154_ctx_t *ctx = calloc(1, sizeof(ws154_ctx_t));
    if (!ctx) return NULL;
