...
static void init_tca9554(board_ctx_t *ctx)
{
    ...
    ret = esp_io_expander_set_dir(ctx->io_expander,
        IO_EXPANDER_PIN_NUM_4 | IO_EXPANDER_PIN_NUM_5 | IO_EXPANDER_PIN_NUM_7,
        IO_EXPANDER_OUTPUT);
    ret |= esp_io_expander_set_dir(ctx->io_expander, IO_EXPANDER_PIN_NUM_3, IO_EXPANDER_INPUT);
    ESP_ERROR_CHECK(ret);
    ret = esp_io_expander_set_level(ctx->io_expander,
        IO_EXPANDER_PIN_NUM_4 | IO_EXPANDER_PIN_NUM_5 | IO_EXPANDER_PIN_NUM_7, 1);
    ESP_ERROR_CHECK(ret);
    vTaskDelay(pdMS_TO_TICKS(100));
    ret = esp_io_expander_set_level(ctx->io_expander,
        IO_EXPANDER_PIN_NUM_4 | IO_EXPANDER_PIN_NUM_5 | IO_EXPANDER_PIN_NUM_7, 0);
    ESP_ERROR_CHECK(ret);
