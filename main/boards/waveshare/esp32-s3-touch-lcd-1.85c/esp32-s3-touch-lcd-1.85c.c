...
static void init_i2c(ws185c_ctx_t *ctx)
{
...
static void init_tca9554(ws185c_ctx_t *ctx)
{
...
static void init_st77916_display(ws185c_ctx_t *ctx)
{
...
static void init_buttons(ws185c_ctx_t *ctx)
{
...
{
    ws185c_ctx_t *ctx = (ws185c_ctx_t *)self;
    if (!ctx->codec) {
...
{
    ws185c_ctx_t *ctx = calloc(1, sizeof(ws185c_ctx_t));
    if (!ctx) return NULL;
